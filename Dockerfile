...
# Importante:
# En este proyecto Angular 17 la salida compilada queda en:
# dist/duocplay-angular-semana4/browser
COPY --from=build /app/dist/aois-cakes-angular/browser /usr/share/nginx/html
